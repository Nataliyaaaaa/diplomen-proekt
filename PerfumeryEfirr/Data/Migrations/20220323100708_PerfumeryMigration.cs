...
{
    public partial class PerfumeryMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Perfumes_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PercentPromotions = table.Column<int>(type: "int", nullable: false),
                    IdPerfume = table.Column<int>(type: "int", nullable: false),
                    DateBegin = table.Column<int>(type: "int", nullable: false),
                    DateEnd = table.Column<int>(type: "int", nullable: false),
                    PerfumesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Promotions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Promotions_Perfumes_PerfumesId",
